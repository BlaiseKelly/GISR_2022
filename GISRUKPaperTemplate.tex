...
\title{System for estimating mortality from air pollution using high resolution population and concentration data}

\author[1]{Blaise Kelly\thanks{blaise.kelly@tno.nl}}
\author[1]{Bas Henzing\thanks{bas.henzing@tno.nl}}
\author[3]{Ioanna Skoulidou\thanks{ioannans@auth.gr}}
\author[2]{Robert Jansen\thanks{robert@zichtopdata.com}}
\author[1]{Janot Tokaya\thanks{janot.tokaya@tno.nl}}
\author[1,4]{Mara Hauck\thanks{mara.hauck@tno.nl}}
\affil[1]{TNO, Climate Air and Sustainability}
\affil[3]{Laboratory of Atmospheric Physics, Aristotle University of Thessaloniki}
\affil[2]{Zicht Op Data BV, Netherlands}
\affil[4]{Technical University Eindhoven}
...
Risk Coefficients from an adapted version of the Global Burden of Disease (GBD) Integrated Exposure Response (IER) model are combined with high temporal and spatial resolution population and air pollution concentration data and local mortality statistics to enable impacts from pollution to be better defined for areas within Eindhoven in the Netherlands.


{\bf KEYWORDS: Particulate Matter (PM), Mortality, Health Effects, Air Quality} 
